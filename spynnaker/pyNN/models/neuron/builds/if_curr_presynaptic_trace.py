...
class IFCurrPresynapticTrace(AbstractPyNNNeuronModelStandard):
    """
    ...
    def __init__(
        ...
        synapse_type = SynapseTypePresynapticTrace(isyn_exc, isyn_inh)
        input_type = InputTypeDelta()
        threshold_type = ThresholdTypeStatic(v_thresh)

        super().__init__(
            model_name="IF_curr_presynaptic_trace", binary="IF_curr_presynaptic_trace.aplx",
